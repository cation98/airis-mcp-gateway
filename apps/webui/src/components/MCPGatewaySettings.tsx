...
export function MCPGatewaySettings() {
  ...
  const [servers, setServers] = useState<Record<ServerSection, MCPServer[]>>({
    ...
    ready: [
      ...
      { id: '12', name: 'airis-mcp-supabase-selfhost', description: 'Database & Auth (Self-hosted)', requiresApiKey: true, status: 'connected', apiKey: '••••••••', toolCount: 22, tokenEstimate: 8900, category: 'external' },
